...
<div class="container">
    <div class="innerBox">
        ...
        <div class="content">
            ...
            <p>
                <label>
                    <input type="checkbox" id="flag1" class="inputCheckBtn" value="checked">
            ...
            <p>
                <label>
                    <input type="checkbox" id="flag2" class="inputCheckBtn" value="checked">
            ...
            <p>
                <label>
                    <input type="checkbox" id="flag3" class="inputCheckBtn" value="checked">
            ...
            <p>
                <label>
                    <input type="checkbox" class="inputCheckBtn">
...
<script>
    window.addEventListener('DOMContentLoaded', (event) => {
        ...
        // 각각의 flag 버튼 클릭 이벤트 처리
        flag1.addEventListener('change', handleCheckboxChange);
        flag2.addEventListener('change', handleCheckboxChange);
        flag3.addEventListener('change', handleCheckboxChange);
        ...
        function updateNextBtnDisplay() {
            // 개별 버튼이 모두 체크되고, 전체 동의 버튼도 체크되었을 때만 다음 버튼 표시
            if (flag1.checked && flag2.checked && flag3.checked || checkAll.checked) {
